...
一个 Manifest V3 浏览器扩展。点击扩展图标后，可以拖入图片或选择本地图片；也可以直接在网页图片上点击右键搜索。扩展会自动调用可返回结构化结果的以图搜图平台，并按相似度排序展示图片、出处和来源链接。

## 下载

- [下载最新安装包（ZIP）](https://github.com/kokoroda/-/releases/download/v1.1.0/image-search-extension-v1.1.0.zip)
...
6. 在任意网页图片上点击右键，选择“使用以图搜图助手搜索此图片”，可以直接开始搜索。
